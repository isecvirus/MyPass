...
public class Encryption {
    public static void encrypt(DefaultTableModel table_model) {
        if (table_model.getRowCount() > 0) {
                FileDialog import_publickey_from = new FileDialog(new JFrame(), "Import (RSA public) key:", FileDialog.LOAD);
